...
pub(crate) fn escape_string(string: &str) -> String {
    ...
    for chr in string.chars() {
        ...
        match chr {
            '"' => escaped.push_str("\"\""),
            // RC.EXE does not recognize \' as an escape sequence; emit the apostrophe literally.
            // The original v0.3.6 implementation emitted "\\'" which broke paths like Project's\.
            '\\' => escaped.push_str("\\\\"),
            '\n' => escaped.push_str("\\n"),
            '\t' => escaped.push_str("\\t"),
